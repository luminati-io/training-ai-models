...
![AR-LSAT dataset example](https://media.brightdata.com/2024/05/AR-LSAT-dataset-example.png)
...
![Billing settings on OpenAI](https://media.brightdata.com/2024/05/Billing-settings-on-OpenAI-1-1024x562.png)

3. Click your profile icon in the top-left corner and select "API Keys" to reach the key creation page.

![Accessing API keys in OpenAI's settings](https://media.brightdata.com/2024/05/Accessing-API-keys-in-OpenAIs-settings-1-1024x396.png)

4. Generate a new secret key by entering a descriptive name.

![Generating a new API key on OpenAI](https://media.brightdata.com/2024/05/Generating-a-new-API-key-on-OpenAI.png)
...
![unique identifiers example](https://media.brightdata.com/2024/05/unique-identifiers-example-1024x87.png)
...
![Example of the information generated by the code above](https://media.brightdata.com/2024/05/Example-of-the-information-generated-by-the-code-above.png)
...
![The fine tuning UI](https://media.brightdata.com/2024/05/The-fine-tuning-UI.png)
...
![the result from the answer dictionary](https://media.brightdata.com/2024/05/the-result-from-the-answer-dictionary.png)
...
![Example of the fine tuned model vs other models in the playground](https://media.brightdata.com/2024/05/Example-of-the-fine-tuned-model-vs-other-models-in-the-playground-1-1024x776.png)
